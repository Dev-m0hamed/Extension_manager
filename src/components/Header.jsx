...
function Header() {
  ...
  return (
    <nav className="pt-8 mb-6 md:mb-8">
      <div className="container mx-auto flex items-center justify-between bg-neutral-0 dark:bg-neutral-800 px-3 py-2 rounded-lg shadow-sm">
        <svg
